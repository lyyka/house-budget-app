    ...
    <ul class="pagination" role="navigation">
        ...
        @foreach ($elements as $element)
            ...
            @if (is_string($element))
                <li class="page-item disabled" aria-disabled="true"><span class="page-link text-info">{{ $element }}</span></li>
            @endif
            ...
            @if (is_array($element))
                @foreach ($element as $page => $url)
                    @if ($page == $paginator->currentPage())
                        <li class="page-item active" aria-current="page"><span class="page-link bg-info border">{{ $page }}</span></li>
                    @else
